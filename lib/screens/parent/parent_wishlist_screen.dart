...
class _ParentWishlistScreenState extends State<ParentWishlistScreen>
    ...
    switch (index) {
      ...
      case 3:
        toastification.show(
          ...
          title: Text('Leaderboard coming soon'),
  ...
  Future<void> _loadChildren() async {
    final trace = FirebasePerformance.instance.newTrace("load_parent_wishlist");
    await trace.start(); // 🔹 Start measuring
    ...
    try {
      ...
      if (childrenList.isEmpty) {
        ...
        await trace.stop(); // 🔹 Stop measurement here too
        return;
      }
      ...
      await trace.stop(); // 🔹 Always stop even on error
    }
  }
