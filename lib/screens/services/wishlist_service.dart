...
class WishlistService {
  ...
  static Stream<List<WishlistItem>> getWishlistItems(String parentId, String childId) {
    print('🔍 WishlistService: Getting wishlist items for parentId: $parentId, childId: $childId');
      ...
      return _firestore
        ...
        for (var doc in snapshot.docs) {
          try {
            ...
            items.add(item);
            print('✅ WishlistService: Successfully parsed item: ${item.name}');
          } catch (e) {
            print('❌ WishlistService: Error parsing document ${doc.id}: $e');
  ...
  static Future<String> addWishlistItem(
    ...
    try {
      print('🔍 WishlistService: Adding item - parentId: $parentId, childId: $childId');
  ...
  static Future<double> getTotalWishlistValue(String parentId, String childId) async {
    try {
