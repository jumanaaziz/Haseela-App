...
class _ChildWishlistDetailsScreenState extends State<ChildWishlistDetailsScreen>
  ...
  String _sortBy = 'name'; // 'name', 'price_low', 'price_high', 'completion'
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            if (isSelected && value == 'completion')
              Icon(
                _sortAscending
                    ? Icons.arrow_upward_rounded
                    : Icons.arrow_downward_rounded,
  ...
  List<WishlistItem> _sortItems(List<WishlistItem> items) {
    ...
    filtered.sort((a, b) {
      ...
      switch (_sortBy) {
        ...
        case 'completion':
          // Sort by purchased status instead of completed
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Move Purchase Button BELOW Description
            if (!item.isPurchased) ...[
